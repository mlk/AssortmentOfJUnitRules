...
/**
 * Starts and stops a local Hadoop DFS cluster for integration testing against Hadoop. For an
 * example of it in action see the <a href="http://tinyurl.com/hadooprule">tests for this
 * class.</a>
 */
